...
public class Registrar extends javax.swing.JFrame {
    ...
    public Registrar(Principal menu, ColaPan colaPan) {
        initComponents();
        
        this.menu = menu;
        this.colaPan = colaPan;
        ...
        jcbRefacccionaria.addItem("Mil hojas");
        jcbRefacccionaria.addItem("Concha ");
        jcbRefacccionaria.addItem("Cuerno Relleno");
        jcbRefacccionaria.addItem("Empanada");
        jcbRefacccionaria.addItem("Ojo de buey");
        jcbRefacccionaria.addItem("Greñuda");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Costo de la pieza");
        ...
        jLabel6.setText("Costo la bebida");
        ...
        jlTipos.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Chocolate", "Cafe", "Tikiti", "Leche" };
    ...
    private void jbnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnAgregarActionPerformed
        ...
        datos();
        colaPan.encolar(PiezaDePan, costo, nombreEmpleado, nombrePan, ganancias);
    ...
    private void datos() {
      ...
      nombreEmpleado = String.valueOf(jcbRefacccionaria.getSelectedItem());
      nombrePan = String.valueOf(jtfNombreTrabajador.getText());
      ganancias = Float.parseFloat(String.valueOf(jtfSueldo.getText()));
      PiezaDePan = String.valueOf(jlTipos.getSelectedValue());
